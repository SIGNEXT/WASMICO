...
const char* filename = "/tasks/7threads_test4.wasm";
...
void _setup() {
    ...
    for (int i = 0; i < 1501; i++) {
        ...
        if (i == 1499) {
            ...
            printInt(finalFreeHeapSize); print(" <- Heap size when ending 4\n");
        }
    }
...
WASM_EXPORT
void _pause() {
    println("Calling pause operation - 7 Threads Load Test - Task 4");
}